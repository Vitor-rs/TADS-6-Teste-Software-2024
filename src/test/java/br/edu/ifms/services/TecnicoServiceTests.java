...
public class TecnicoServiceTests {
    ...
    public void findByIdDeveriaRetornarObjetoQuandoIdExistir() {
        TecnicoDTO result = service.findById(idExistente);
    ...
    @Test
    public void updateDeveriaAtualizarQuandoIdExistir() {
        TecnicoDTO dto = Factory.createTecnicoDTO();
